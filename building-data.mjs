export const buildings = [
  {
    ...
    facts: [
      ['Model', 'Linked to model.glb'],
      ['Detail', 'Tang timber frame, dougong, murals, sculptures'],
    ],
    pretextNote: 'Enter the 3D detail layer to inspect the monastery model with wraparound text and gesture control.',
    pretextTitle: `FOGUANG
MONASTERY`,
    pretextKicker: 'Shanxi / Tang Timber',
    pretextText: `
...
`.trim(),
  },
  {
    ...
    facts: [
      ['Model', 'Linked to model.glb'],
      ['Detail', 'Dacheng Hall, Confucius statue, ritual axis'],
    ],
    pretextNote: 'Enter the 3D detail layer to inspect the temple model with wraparound text and gesture control.',
    pretextTitle: `HUIZE
CONFUCIAN
TEMPLE`,
    pretextKicker: 'Yunnan / Qing Ritual Space',
    pretextText: `
...
`.trim(),
  },
  {
    ...
    facts: [
      ['Model', 'Linked to model.glb'],
      ['Detail', 'Hexagonal tower, brick eaves, leaning crown'],
    ],
    pretextNote: 'Enter the Pretext-3D detail layer to inspect the pagoda model with wraparound text and gesture control.',
    pretextTitle: `HENGLANG
ANCIENT
PAGODA`,
    pretextKicker: 'Anhui / Southern Song Tower',
    pretextText: `
